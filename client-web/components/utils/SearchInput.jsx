  ...
  return (
    <div className="relative w-full">
      ...
      {showOptions && items.length > 0 && (
        <ul className="absolute bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-600 rounded-md mt-1 w-full max-h-40 overflow-y-auto z-30 shadow-lg">
          {items.map((item) => (
            <li
              key={item.id}
